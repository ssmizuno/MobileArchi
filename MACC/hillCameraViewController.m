...
#import "hillCameraViewController.h"
#import "ConfirmViewController.h"
#import "Chair04ViewController.h"

@implementation hillCameraViewController

@synthesize imagePicker, overImageView, imageNameSmall, imageNameBig, indicator, saveImage, bgimg;
...
- (void)viewDidLoad
{
    ...
    imageIndex = 0;
    //プレビュー用画像配列
    imageNameSmall = [[NSMutableArray alloc] initWithObjects:@"image2Small01.png", @"image2Small02.png", @"image2Small03.png", nil];
    //保存用画像配列
    imageNameBig = [[NSMutableArray alloc] initWithObjects:@"image2Big01.png", @"image2Big02.png", @"image2Big03.png", nil];
