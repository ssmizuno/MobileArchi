//
//  KansaiYamamotoViewController.m
//  MACC
//
...
@implementation RikenYamamotoViewController
...
- (void)viewDidLoad {     
    ...
    //portrait画像
    UIImage *photo = [UIImage imageNamed:@"yamamoto.png"];
    ...
    NSString *textPath = [[NSBundle mainBundle] pathForResource:@"yamamoto" ofType:@"txt"];
